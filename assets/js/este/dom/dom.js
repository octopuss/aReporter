...
goog.scope(function() {
  ...
  /**
    ...
    @return {boolean}
  */
  _.match = function(node, selector) {
  ...
  */
  ...
  _.getAncestors = function(el, opt_includeNode, opt_stopOnBody) {
    var els;
    els = [];
    if (!opt_includeNode) {
      el = el.parentNode;
    ...
    while (el) {
      if (opt_stopOnBody && el.tagName === 'BODY') {
        break;
      }
      els.push(el);
      el = el.parentNode;
  ...
  */
  ...
  _.getDomPath = function(elements) {
    ...
    for (_i = 0, _len = elements.length; _i < _len; _i++) {
      ...
      _ref = goog.dom.classes.get(element);
      for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
        className = _ref[_j];
        path.push('.', className);
      }
  ...
  */
  ...
  _.insert = function(newNode, refNode, where) {
    switch (where) {
      case 'before':
  ...
  */
  ...
  _.onTargetWithClass = function(e, object) {
  ...
  */
  ...
  _.getSingleFormValueByName = function(form, name) {
    form = /** @type {HTMLFormElement} */ (form);
  ...
  */
  ...
  _.getDomPathIndexes = function(element) {
  ...
  */
  ...
  _.getElementByDomPathIndex = function(path, doc) {
    var element, index;
    if (doc == null) {
      doc = document;
    }
