...
este.demos.app.simplehtml5.start = function(data) {
  ...
  timer = null;
  myApp = este.app.create(appEl, [este.demos.app.simplehtml5.products.View, este.demos.app.simplehtml5.product.View]);
  myApp.data = data;
