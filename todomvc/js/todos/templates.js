...
este.demos.app.todomvc.todos.templates.main = function(opt_data) {
  ...
  var todoList22 = opt_data.todos;
  var todoListLen22 = todoList22.length;
  for (var todoIndex22 = 0; todoIndex22 < todoListLen22; todoIndex22++) {
    var todoData22 = todoList22[todoIndex22];
    output += este.demos.app.todomvc.todos.templates.todo(todoData22);
  }
  output += '</ul></section>';
  return output;
};
